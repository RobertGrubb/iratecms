    ...
    <div class="row-fluid">
        <div class="col-lg-8">
            <div class="row-fluid">
                ...
                <div class="panel panel-default half-panel hidden-sm hidden-xs hidden-md" style="width:352px;">
                    <div class="panel-heading">
                        <h3 class="panel-title">Facebook</h3>
                    </div>
                    <div class="panel-body">
                        <iframe src="//www.facebook.com/plugins/likebox.php?href=<?php echo $settings['facebook_url']; ?>&amp;width=327&amp;height=316&amp;colorscheme=light&amp;show_faces=true&amp;border_color=%23DDDDDD&amp;stream=false&amp;header=false&amp;appId=233947343289787" scrolling="no" frameborder="0" style="border:none; overflow:hidden; height: 316px; width: 322px" allowTransparency="true"></iframe>
                    </div>
                </div>
