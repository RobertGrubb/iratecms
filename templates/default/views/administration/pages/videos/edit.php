	...
	<form action="" method="post">
		<table class="glob-table">
			<tr>
				...
				<td><input type="text" name="title" class="glob-input" value="<?php echo $v["title"]; ?>" /></td>
			</tr>
			<tr>
				<td class="left" valign="top">Youtube Video ID</td>
				<td>
					<input type="text" name="source" class="glob-input" value="<?php echo $v["source"]; ?>" /><br />
			...
			<tr>
				...
				<td>
					<input type="submit" value="Save Video" class="glob-button" />
				</td>
			</tr>
		</table>
	</form>
