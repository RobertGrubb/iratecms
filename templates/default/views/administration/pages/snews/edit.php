	...
	<form action="" method="post" enctype="multipart/form-data">
		<table class="glob-table">
            ...
            <tr>
				...
				<td><input type="text" name="short_desc" class="glob-input" value="<?php echo $n["short_desc"]; ?>" /></td>
			</tr>
            <tr>
				<td class="left" valign="top">Cover Image</td>
				<td>
                    <?php if(!empty($n['image'])): ?>
                        <img src="<?php echo url(); ?>uploads/news/<?php echo $n['image']; ?>" style="width:120px;max-width:120px;" /><br />
                    <?php else: ?>
			...
			<tr>
				...
				<td>
				    <textarea id="reply-textarea" name="content" style="height:500px;width:100%;"><?php echo $n["content"]; ?></textarea>
				</td>
			</tr>
			<tr>
