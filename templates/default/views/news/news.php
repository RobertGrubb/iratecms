                ...
                <div class="panel-body">
                    ...
                    <div class="media">
                        <a class="pull-left" href="<?php url(); ?>news/view/<?php echo $post["id"]; ?>">
                            <img class="media-object" src="<?php if(empty($post['image']) || is_null($post['image'])): ?><?php echo url(); ?>uploads/avatars/default.jpg<?php else: ?><?php echo url(); ?>uploads/news/<?php echo $post['image']; ?><?php endif; ?>" alt="<?php echo $post["title"]; ?>" width="100">
                        </a>
