...
$db_config_path = '../ci/application/config/database.php';
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    ?>">
		 <fieldset>
          ...
          <label for="hostname">Site URL</label><input type="text" id="site_url" value="http://www.yoursite.com/" class="input_text" name="site_url" />
        </fieldset>
        <fieldset>
