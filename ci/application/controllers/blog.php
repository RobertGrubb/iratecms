...
class Blog extends MY_Controller
{
    ...
    public function index()
    {
        ...
        //Load the template
        $this->load->view($this->blog_template_dir.'blog.php', $data);
    }
    ...
    public function view()
    {
        ...
        $blogid = $this->db->get('blogs');
        //Check if it exists:
        if ($blogid->num_rows() >= 1) {
            //Set the user information to the data array
            $data['blog'] = $blogid->result_array();
            //Load the view file
            $this->load->view($this->blog_template_dir.'view.php', $data);
        }
